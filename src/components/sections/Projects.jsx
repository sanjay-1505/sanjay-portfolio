          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                Full-stack e-commerce with modern UI, access permissions, and customizable product inventory.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["React","JWT", "Node.js", "Express.js", "MongoDB"].map((tech, key) => (
                  <span
                    key={key}
            ...
            "
            >
              <h3 className="text-xl font-bold mb-2">Nachammai Pest Control(Consultancy Project)</h3>
              <p className="text-gray-400 mb-4">
                Web Applications with attractive UI,chat system integration and also contact form connectivity using emailjs.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["React", "TailwindCSS", "EmailJS", "Framer-motions"].map((tech, key) => (
                  <span
                    key={key}
                    className="
            ...
            >
              ...
              <p className="text-gray-400 mb-4">
                Forecasting and finding the current and future Stock Prices using Stock ID.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["Python", "LSTM", "Facebook Prophet", "Streamlit"].map((tech, key) => (
                  <span
                    key={key}
                    className="
                      bg-blue-500/10 text-blue-500 py-1 px-3 
